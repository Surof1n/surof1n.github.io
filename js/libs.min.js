!function (t) {
  ...
  n = 0, (a = function (t, e) {
    ...
    if (s = document.createDocumentFragment(), o = r.$slider.children(), 0 < r.options.rows) {
    ...
    if (!0 === t.options.infinite) {
      if (t.slideCount <= t.options.slidesToShow) ++s;else for (; e < t.slideCount;) ++s, e = i + t.options.slidesToScroll, i += t.options.slidesToScroll <= t.options.slidesToShow ? t.options.slidesToScroll : t.options.slidesToShow;
    } else if (!0 === t.options.centerMode) s = t.slideCount;else if (t.options.asNavFor) for (; e < t.slideCount;) ++s, e = i + t.options.slidesToScroll, i += t.options.slidesToScroll <= t.options.slidesToShow ? t.options.slidesToScroll : t.options.slidesToShow;else s = 1 + Math.ceil((t.slideCount - t.options.slidesToShow) / t.options.slidesToScroll);
    return s - 1;
    ...
    var s = this,
        ...
        n = s.getNavigableIndexes().filter(function (t) {
    ...
    !0 === t.options.dots && t.slideCount > t.options.slidesToShow && (h("li", t.$dots).on("click.slick", {
      message: "index"
    }, t.changeSlide), !0 === t.options.accessibility && t.$dots.on("keydown.slick", t.keyHandler)), !0 === t.options.dots && !0 === t.options.pauseOnDotsHover && t.slideCount > t.options.slidesToShow && h("li", t.$dots).on("mouseenter.slick", h.proxy(t.interrupt, t, !0)).on("mouseleave.slick", h.proxy(t.interrupt, t, !1));
    ...
    if (!0 === o.options.centerMode ? i = !0 === o.options.infinite ? (e = o.currentSlide + (o.options.slidesToShow / 2 + 1)) + o.options.slidesToShow + 2 : (e = Math.max(0, o.currentSlide - (o.options.slidesToShow / 2 + 1)), o.options.slidesToShow / 2 + 1 + 2 + o.currentSlide) : (e = o.options.infinite ? o.options.slidesToShow + o.currentSlide : o.currentSlide, i = Math.ceil(e + o.options.slidesToShow), !0 === o.options.fade && (0 < e && e--, i <= o.slideCount && i++)), t = o.$slider.find(".slick-slide").slice(e, i), "anticipated" === o.options.lazyLoad) for (var n = e - 1, a = i, r = o.$slider.find(".slick-slide"), l = 0; l < o.options.slidesToScroll; l++) n < 0 && (n = o.slideCount - 1), t = (t = t.add(r.eq(n))).add(r.eq(a)), n--, a++;
    ...
    if ("array" === h.type(n) && n.length) {
      for (t in s.respondTo = s.options.respondTo || "window", n) if (i = s.breakpoints.length - 1, n.hasOwnProperty(t)) {
    ...
    var t,
        ...
        o = this,
        a = !1;
    if ("object" === h.type(arguments[0]) ? (i = arguments[0], a = arguments[1], n = "multiple") : "string" === h.type(arguments[0]) && (s = arguments[1], a = arguments[2], "responsive" === (i = arguments[0]) && "array" === h.type(arguments[1]) ? n = "responsive" : void 0 !== arguments[1] && (n = "single")), "single" === n) o.options[i] = s;else if ("multiple" === n) h.each(i, function (t, e) {
      o.options[t] = e;
    });else if ("responsive" === n) for (e in s) if ("array" !== h.type(o.options.responsive)) o.options.responsive = [s[e]];else {
    ...
    var s,
        ...
        l,
        h = this;
    if (e = e || !1, !(!0 === h.animating && !0 === h.options.waitForAnimate || !0 === h.options.fade && h.currentSlide === t)) if (!1 === e && h.asNavFor(t), s = t, r = h.getLeft(s), a = h.getLeft(h.currentSlide), h.currentLeft = null === h.swipeLeft ? a : h.swipeLeft, !1 === h.options.infinite && !1 === h.options.centerMode && (t < 0 || t > h.getDotCount() * h.options.slidesToScroll)) !1 === h.options.fade && (s = h.currentSlide, !0 !== i && h.slideCount > h.options.slidesToShow ? h.animateSlide(a, function () {
      h.postSlide(s);
    }) : h.postSlide(s));else if (!1 === h.options.infinite && !0 === h.options.centerMode && (t < 0 || t > h.slideCount - h.options.slidesToScroll)) !1 === h.options.fade && (s = h.currentSlide, !0 !== i && h.slideCount > h.options.slidesToShow ? h.animateSlide(a, function () {
      h.postSlide(s);
    }) : h.postSlide(s));else {
      if (h.options.autoplay && clearInterval(h.autoPlayTimer), n = s < 0 ? h.slideCount % h.options.slidesToScroll != 0 ? h.slideCount - h.slideCount % h.options.slidesToScroll : h.slideCount + s : s >= h.slideCount ? h.slideCount % h.options.slidesToScroll != 0 ? 0 : s - h.slideCount : s, h.animating = !0, h.$slider.trigger("beforeChange", [h, h.currentSlide, n]), o = h.currentSlide, h.currentSlide = n, h.setSlideClasses(h.currentSlide), h.options.asNavFor && (l = (l = h.getNavTarget()).slick("getSlick")).slideCount <= l.options.slidesToShow && l.setSlideClasses(h.currentSlide), h.updateDots(), h.updateArrows(), !0 === h.options.fade) return !0 !== i ? (h.fadeSlideOut(o), h.fadeSlide(n, function () {
        h.postSlide(n);
  ...
  C.cleanData = (n = C.cleanData, function (t) {
    var e, i, s;
    ...
    for (var e, i, s = r.call(arguments, 1), n = 0, o = s.length; n < o; n++) for (e in s[n]) i = s[n][e], s[n].hasOwnProperty(e) && void 0 !== i && (C.isPlainObject(i) ? t[e] = C.isPlainObject(t[e]) ? C.widget.extend({}, t[e], i) : C.widget.extend({}, i) : t[e] = i);
    ...
    _classes: function (n) {
      ...
      function t(t, e) {
        ...
        for (s = 0; s < t.length; s++) i = a.classesElementLookup[t[s]] || C(), i = n.add ? C(C.unique(i.get().concat(n.element.get()))) : C(i.not(n.element).get()), a.classesElementLookup[t[s]] = i, o.push(t[s]), e && n.classes[t[s]] && o.push(n.classes[t[s]]);
      }
  ...
  k = Math.max, x = Math.abs, s = /left|center|right/, a = /top|center|bottom/, l = /[\+\-]\d+(\.[\d]+)?%?/, h = /^\w+/, c = /%$/, e = C.fn.position, C.position = {
    scrollbarWidth: function () {
      ...
      var t,
          ...
          s = i.children()[0];
      return C("body").append(i), t = s.offsetWidth, i.css("overflow", "scroll"), t === (e = s.offsetWidth) && (e = i[0].clientWidth), i.remove(), o = t - e;
    },
    ...
    return t = function (t) {
    ...
    }(v), v[0].preventDefault && (d.at = "left top"), p = t.width, f = t.height, g = t.offset, m = C.extend({}, g), C.each(["my", "at"], function () {
      var t,
          e,
          i = (d[this] || "").split(" ");
      1 === i.length && (i = s.test(i[0]) ? i.concat(["center"]) : a.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = s.test(i[0]) ? i[0] : "center", i[1] = a.test(i[1]) ? i[1] : "center", t = l.exec(i[0]), e = l.exec(i[1]), w[this] = [t ? t[0] : 0, e ? e[0] : 0], d[this] = [h.exec(i[0])[0], h.exec(i[1])[0]];
    }), 1 === y.length && (y[1] = y[0]), "right" === d.at[0] ? m.left += p : "center" === d.at[0] && (m.left += p / 2), "bottom" === d.at[1] ? m.top += f : "center" === d.at[1] && (m.top += f / 2), u = T(w.at, p, f), m.left += u[0], m.top += u[1], this.each(function () {
      var i,
          t,
          a = C(this),
          r = a.outerWidth(),
          ...
          h = C.extend({}, m),
          c = T(w.my, a.outerWidth(), a.outerHeight());
      "right" === d.my[0] ? h.left -= r : "center" === d.my[0] && (h.left -= r / 2), "bottom" === d.my[1] ? h.top -= l : "center" === d.my[1] && (h.top -= l / 2), h.left += c[0], h.top += c[1], i = {
        ...
        p < r && x(e + i) < p && (o.horizontal = "center"), f < l && x(s + n) < f && (o.vertical = "middle"), k(x(e), x(i)) > k(x(s), x(n)) ? o.important = "horizontal" : o.important = "vertical", d.using.call(this, t, o);
      }), a.offset(C.extend(h, {
        using: t
      }));
    });
    ...
    fit: {
      left: function (t, e) {
        ...
        e.collisionWidth > o ? 0 < r && l <= 0 ? (i = t.left + r + e.collisionWidth - o - n, t.left += r - i) : t.left = 0 < l && r <= 0 ? n : l < r ? n + o - e.collisionWidth : n : 0 < r ? t.left += r : 0 < l ? t.left -= l : t.left = k(t.left - a, t.left);
      },
      top: function (t, e) {
        var i,
            s = e.within,
        ...
        e.collisionHeight > o ? 0 < r && l <= 0 ? (i = t.top + r + e.collisionHeight - o - n, t.top += r - i) : t.top = 0 < l && r <= 0 ? n : l < r ? n + o - e.collisionHeight : n : 0 < r ? t.top += r : 0 < l ? t.top -= l : t.top = k(t.top - a, t.top);
      }
    },
    flip: {
      left: function (t, e) {
        var i,
            ...
            p = -2 * e.offset[0];
        h < 0 ? ((i = t.left + d + u + p + e.collisionWidth - a - o) < 0 || i < x(h)) && (t.left += d + u + p) : 0 < c && (0 < (s = t.left - e.collisionPosition.marginLeft + d + u + p - r) || x(s) < c) && (t.left += d + u + p);
      },
      top: function (t, e) {
        var i,
            s,
            ...
            p = -2 * e.offset[1];
        h < 0 ? ((s = t.top + d + u + p + e.collisionHeight - a - o) < 0 || s < x(h)) && (t.top += d + u + p) : 0 < c && (0 < (i = t.top - e.collisionPosition.marginTop + d + u + p - r) || x(i) < c) && (t.top += d + u + p);
      }
    },
    flipfit: {
      left: function () {
  ...
  "1.7" === C.fn.jquery.substring(0, 3) && (C.each(["Width", "Height"], function (t, i) {
    ...
    C.fn["inner" + i] = function (t) {
      return void 0 === t ? o["inner" + i].call(this) : this.each(function () {
        C(this).css(s, a(this, t) + "px");
      });
    }, C.fn["outer" + i] = function (t, e) {
      return "number" != typeof t ? o["outer" + i].call(this, t) : this.each(function () {
        C(this).css(s, a(this, t, !0, e) + "px");
      });
    };
  ...
  C.ui.keyCode = {
    ...
    TAB: 9,
    UP: 38
  }, C.ui.escapeSelector = (d = /([!"#$%&'()*+,./:;<=>?@[\]^`{|}~])/g, function (t) {
  ...
  C.widget("ui.mouse", {
    ...
    _mouseDown: function (t) {
      if (!p) {
        ...
        return !(i && !s && this._mouseCapture(t)) || (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function () {
          ...
          return e._mouseUp(t);
        }, this.document.on("mousemove." + this.widgetName, this._mouseMoveDelegate).on("mouseup." + this.widgetName, this._mouseUpDelegate), t.preventDefault(), p = !0));
      }
    },
    ...
    _mouseUp: function (t) {
      this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, t.target === this._mouseDownEvent.target && C.data(t.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(t)), this._mouseDelayTimer && (clearTimeout(this._mouseDelayTimer), delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, p = !1, t.preventDefault();
    },
  ...
  C.widget("ui.draggable", C.ui.mouse, {
    ...
    drag: function (t, e, i) {
      ...
      for (d = i.snapElements.length - 1; 0 <= d; d--) l = (r = i.snapElements[d].left - i.margins.left) + i.snapElements[d].width, c = (h = i.snapElements[d].top - i.margins.top) + i.snapElements[d].height, m < r - f || l + f < g || _ < h - f || c + f < v || !C.contains(i.snapElements[d].item.ownerDocument, i.snapElements[d].item) ? (i.snapElements[d].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, C.extend(i._uiHash(), {
        snapItem: i.snapElements[d].item
      })), i.snapElements[d].snapping = !1) : ("inner" !== p.snapMode && (s = Math.abs(h - _) <= f, n = Math.abs(c - v) <= f, o = Math.abs(r - m) <= f, a = Math.abs(l - g) <= f, s && (e.position.top = i._convertPositionTo("relative", {
        ...
        top: 0,
        left: l
      }).left)), u = s || n || o || a, "outer" !== p.snapMode && (s = Math.abs(h - v) <= f, n = Math.abs(c - _) <= f, o = Math.abs(r - g) <= f, a = Math.abs(l - m) <= f, s && (e.position.top = i._convertPositionTo("relative", {
        top: h,
        left: 0
      }).top), n && (e.position.top = i._convertPositionTo("relative", {
      ...
      }).left)), !i.snapElements[d].snapping && (s || n || o || a || u) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, C.extend(i._uiHash(), {
        snapItem: i.snapElements[d].item
      })), i.snapElements[d].snapping = s || n || o || a || u);
    }
  ...
  C.widget("ui.droppable", {
    ...
    _setOption: function (t, e) {
      if ("accept" === t) this.accept = C.isFunction(e) ? e : function (t) {
        return t.is(e);
      };else if ("scope" === t) {
    ...
    _drop: function (e, t) {
      ...
      return !(!i || (i.currentItem || i.element)[0] === this.element[0]) && (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
        ...
        if (t.options.greedy && !t.options.disabled && t.options.scope === i.options.scope && t.accept.call(t.element[0], i.currentItem || i.element) && f(i, C.extend(t, {
  ...
  var f = C.ui.intersect = function (t, e, i, s) {
  ...
  !(C.ui.ddmanager = {
    ...
    drop: function (t, e) {
      ...
      return C.each((C.ui.ddmanager.droppables[t.options.scope] || []).slice(), function () {
        this.options && (!this.options.disabled && this.visible && f(t, this, this.options.tolerance, e) && (i = this._drop.call(this, e) || i), !this.options.disabled && this.visible && this.accept.call(this.element[0], t.currentItem || t.element) && (this.isout = !0, this.isover = !1, this._deactivate.call(this, e)));
      }), i;
    },
      ...
      o.options.refreshPositions && C.ui.ddmanager.prepareOffsets(o, a), C.each(C.ui.ddmanager.droppables[o.options.scope] || [], function () {
        if (!this.options.disabled && !this.greedyChild && this.visible) {
          var t,
              e,
              i,
              s = f(o, this, this.options.tolerance, a),
  ...
  C.widget("ui.resizable", C.ui.mouse, {
    ...
    _setupHandles: function () {
      ...
      if (this.handles = o.handles || (C(".ui-resizable-handle", this.element).length ? {
        ...
        ne: ".ui-resizable-ne",
        nw: ".ui-resizable-nw"
      } : "e,s,se"), this._handles = C(), this.handles.constructor === String) for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), i = this.handles.split(","), this.handles = {}, e = 0; e < i.length; e++) s = "ui-resizable-" + (t = C.trim(i[e])), n = C("<div>"), this._addClass(n, "ui-resizable-handle " + s), n.css({
        zIndex: o.zIndex
  ...
  C.ui.resizable, C.widget("ui.selectable", C.ui.mouse, {
    ...
    _getItemsAsjQuery: function (t) {
      ...
      if (r && t) for (e = r.length - 1; 0 <= e; e--) for (i = (s = C(r[e], this.document[0])).length - 1; 0 <= i; i--) (n = C.data(s[i], this.widgetFullName)) && n !== this && !n.options.disabled && a.push([C.isFunction(n.options.items) ? n.options.items.call(n.element) : C(n.options.items, n.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), n]);
      ...
      }) : C(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]), e = a.length - 1; 0 <= e; e--) a[e][0].each(l);
    ...
    _refreshItems: function (t) {
      ...
      var e,
          ...
          l,
          h = this.items,
          c = [[C.isFunction(this.options.items) ? this.options.items.call(this.element[0], t, {
        item: this.currentItem
      }) : C(this.options.items, this.element), this]],
          d = this._connectWith();

      if (d && this.ready) for (e = d.length - 1; 0 <= e; e--) for (i = (s = C(d[e], this.document[0])).length - 1; 0 <= i; i--) (n = C.data(s[i], this.widgetFullName)) && n !== this && !n.options.disabled && (c.push([C.isFunction(n.options.items) ? n.options.items.call(n.element[0], t, {
        item: this.currentItem
      }) : C(n.options.items, n.element), n]), this.containers.push(n));

      for (e = c.length - 1; 0 <= e; e--) for (o = c[e][1], i = 0, l = (a = c[e][0]).length; i < l; i++) (r = C(a[i])).data(this.widgetName + "-item", o), h.push({
        item: r,
        instance: o,
        width: 0,
        height: 0,
    ...
    _contactContainers: function (t) {
      ...
      for (e = this.containers.length - 1; 0 <= e; e--) if (!C.contains(this.currentItem[0], this.containers[e].element[0])) if (this._intersectsWith(this.containers[e].containerCache)) {
        if (d && C.contains(this.containers[e].element[0], d.element[0])) continue;
        d = this.containers[e], u = e;
      ...
      if (d) if (1 === this.containers.length) this.containers[u].containerCache.over || (this.containers[u]._trigger("over", t, this._uiHash(this)), this.containers[u].containerCache.over = 1);else {
        for (s = 1e4, n = null, o = (h = d.floating || this._isFloating(this.currentItem)) ? "left" : "top", a = h ? "width" : "height", c = h ? "pageX" : "pageY", i = this.items.length - 1; 0 <= i; i--) C.contains(this.containers[u].element[0], this.items[i].item[0]) && this.items[i].item[0] !== this.currentItem[0] && (r = this.items[i].item.offset()[o], l = !1, t[c] - r > this.items[i][a] / 2 && (l = !0), Math.abs(t[c] - r) < s && (s = Math.abs(t[c] - r), n = this.items[i], this.direction = l ? "up" : "down"));
        ...
        n ? this._rearrange(t, n, null, !0) : this._rearrange(t, null, this.containers[u].element, !0), this._trigger("change", t, this._uiHash()), this.containers[u]._trigger("change", t, this._uiHash(this)), this.currentContainer = this.containers[u], this.options.placeholder.update(this.currentContainer, this.placeholder), this.containers[u]._trigger("over", t, this._uiHash(this)), this.containers[u].containerCache.over = 1;
      }
    },
    _createHelper: function (t) {
      var e = this.options,
  ...
  C.widget("ui.autocomplete", {
      ...
      this.isMultiLine = e || !o && this._isContentEditable(this.element), this.valueMethod = this.element[e || o ? "val" : "text"], this.isNewMenu = !0, this._addClass("ui-autocomplete-input"), this.element.attr("autocomplete", "off"), this._on(this.element, {
        ...
        menufocus: function (t, e) {
          ...
          s = e.item.data("ui-autocomplete-item"), !1 !== this._trigger("focus", t, {
            item: s
          }) && t.originalEvent && /^key/.test(t.originalEvent.type) && this._value(s.value), (i = e.item.attr("aria-label") || s.value) && C.trim(i).length && (this.liveRegion.children().hide(), C("<div>").text(i).appendTo(this.liveRegion));
        },
    ...
    filter: function (t, e) {
      var i = new RegExp(C.ui.autocomplete.escapeRegex(e), "i");
  ...
  C.widget("ui.controlgroup", {
      ...
      C.each(this.options.items, function (n, t) {
        ...
        if (t) return "controlgroupLabel" === n ? ((e = a.element.find(t)).each(function () {
          ...
          if ("button" !== n || !t.parent(".ui-spinner").length) {
            (e = e || t[n]()[n]("instance")) && (i.classes = a._resolveClassesValues(i.classes, e)), t[n](i);
            var s = t[n]("widget");
            C.data(s[0], "ui-controlgroup-data", e || t[n]("instance")), r.push(s[0]);
          }
        })));
    ...
    _resolveClassesValues: function (i, s) {
      ...
      return C.each(i, function (t) {
        ...
        e = C.trim(e.replace(m, "")), n[t] = (e + " " + i[t]).replace(/\s+/g, " ");
      }), n;
    },
    _setOption: function (t, e) {
  ...
  }), C.fn.button = (v = C.fn.button, function () {
    return !this.length || this.length && "INPUT" !== this[0].tagName || this.length && "INPUT" === this[0].tagName && "checkbox" !== this.attr("type") && "radio" !== this.attr("type") ? v.apply(this, arguments) : (C.ui.checkboxradio || C.error("Checkboxradio widget missing"), 0 === arguments.length ? this.checkboxradio({
      icon: !1
  ...
  function b() {
    this._curInst = null, this._keyEvent = !1, this._disabledInputs = [], this._datepickerShowing = !1, this._inDialog = !1, this._mainDivId = "ui-datepicker-div", this._inlineClass = "ui-datepicker-inline", this._appendClass = "ui-datepicker-append", this._triggerClass = "ui-datepicker-trigger", this._dialogClass = "ui-datepicker-dialog", this._disableClass = "ui-datepicker-disabled", this._unselectableClass = "ui-datepicker-unselectable", this._currentClass = "ui-datepicker-current-day", this._dayOverClass = "ui-datepicker-days-cell-over", this.regional = [], this.regional[""] = {
      ...
      autoSize: !1,
      disabled: !1
    }, C.extend(this._defaults, this.regional[""]), this.regional.en = C.extend(!0, {}, this.regional[""]), this.regional["en-US"] = C.extend(!0, {}, this.regional.en), this.dpDiv = y(C("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"));
  }
  ...
  function w() {
    C.datepicker._isDisabledDatepicker(_.inline ? _.dpDiv.parent()[0] : _.input[0]) || (C(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"), C(this).addClass("ui-state-hover"), -1 !== this.className.indexOf("ui-datepicker-prev") && C(this).addClass("ui-datepicker-prev-hover"), -1 !== this.className.indexOf("ui-datepicker-next") && C(this).addClass("ui-datepicker-next-hover"));
  }
  ...
  C.extend(C.ui, {
    ...
    _newInst: function (t, e) {
      return {
        ...
        drawYear: 0,
        inline: e,
        dpDiv: e ? y(C("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")) : this.dpDiv
      };
    },
    ...
    _dialogDatepicker: function (t, e, i, s, n) {
      var o,
          ...
          h,
          c = this._dialogInst;
      return c || (this.uuid += 1, o = "dp" + this.uuid, this._dialogInput = C("<input type='text' id='" + o + "' style='position: absolute; top: -100px; width: 0px;'/>"), this._dialogInput.on("keydown", this._doKeyDown), C("body").append(this._dialogInput), (c = this._dialogInst = this._newInst(this._dialogInput, !1)).settings = {}, C.data(this._dialogInput[0], "datepicker", c)), S(c.settings, s || {}), e = e && e.constructor === Date ? this._formatDate(c, e) : e, this._dialogInput.val(e), this._pos = n ? n.length ? n : [n.pageX, n.pageY] : null, this._pos || (a = document.documentElement.clientWidth, r = document.documentElement.clientHeight, l = document.documentElement.scrollLeft || document.body.scrollLeft, h = document.documentElement.scrollTop || document.body.scrollTop, this._pos = [a / 2 - 100 + l, r / 2 - 150 + h]), this._dialogInput.css("left", this._pos[0] + 20 + "px").css("top", this._pos[1] + "px"), c.settings.onSelect = i, this._inDialog = !0, this.dpDiv.addClass(this._dialogClass), this._showDatepicker(this._dialogInput[0]), C.blockUI && C.blockUI(this.dpDiv), C.data(this._dialogInput[0], "datepicker", c), this;
    },
    ...
    _optionDatepicker: function (t, e, i) {
      ...
      s = e || {}, "string" == typeof e && ((s = {})[e] = i), r && (this._curInst === r && this._hideDatepicker(), n = this._getDateDatepicker(t, !0), o = this._getMinMaxDate(r, "min"), a = this._getMinMaxDate(r, "max"), S(r.settings, s), null !== o && void 0 !== s.dateFormat && void 0 === s.minDate && (r.settings.minDate = this._formatDate(r, o)), null !== a && void 0 !== s.dateFormat && void 0 === s.maxDate && (r.settings.maxDate = this._formatDate(r, a)), "disabled" in s && (s.disabled ? this._disableDatepicker(t) : this._enableDatepicker(t)), this._attachments(C(t), r), this._autoSize(r), this._setDate(r, n), this._updateAlternate(r), this._updateDatepicker(r));
    },
    ...
    _showDatepicker: function (t) {
      ...
      "input" !== (t = t.target || t).nodeName.toLowerCase() && (t = C("input", t.parentNode)[0]), C.datepicker._isDisabledDatepicker(t) || C.datepicker._lastInput === t || (e = C.datepicker._getInst(t), C.datepicker._curInst && C.datepicker._curInst !== e && (C.datepicker._curInst.dpDiv.stop(!0, !0), e && C.datepicker._datepickerShowing && C.datepicker._hideDatepicker(C.datepicker._curInst.input[0])), !1 !== (s = (i = C.datepicker._get(e, "beforeShow")) ? i.apply(t, [t, e]) : {}) && (S(e.settings, s), e.lastVal = null, C.datepicker._lastInput = t, C.datepicker._setDateFromField(e), C.datepicker._inDialog && (t.value = ""), C.datepicker._pos || (C.datepicker._pos = C.datepicker._findPos(t), C.datepicker._pos[1] += t.offsetHeight), n = !1, C(t).parents().each(function () {
        ...
        left: o.left + "px",
        top: o.top + "px"
      }), e.inline || (a = C.datepicker._get(e, "showAnim"), r = C.datepicker._get(e, "duration"), e.dpDiv.css("z-index", function (t) {
        ...
        return 0;
      }(C(t)) + 1), C.datepicker._datepickerShowing = !0, C.effects && C.effects.effect[a] ? e.dpDiv.show(a, C.datepicker._get(e, "showOptions"), r) : e.dpDiv[a || "show"](a ? r : null), C.datepicker._shouldFocusInput(e) && e.input.trigger("focus"), C.datepicker._curInst = e)));
    },
    ...
    parseDate: function (i, o, t) {
      ...
      for (r = 0; r < i.length; r++) if (k) "'" !== i.charAt(r) || a("'") ? n() : k = !1;else switch (i.charAt(r)) {
        case "d":
          y = e("d");
          break;
      ...
      if (-1 === _ ? _ = new Date().getFullYear() : _ < 100 && (_ += new Date().getFullYear() - new Date().getFullYear() % 100 + (_ <= p ? 0 : -100)), -1 < w) for (b = 1, y = w;;) {
        if (y <= (l = this._getDaysInMonth(_, b - 1))) break;
        b++, y -= l;
      }
    ...
    formatDate: function (i, t, e) {
      ...
      var a,
          ...
          d = "",
          u = !1;
      if (t) for (a = 0; a < i.length; a++) if (u) "'" !== i.charAt(a) || n("'") ? d += i.charAt(a) : u = !1;else switch (i.charAt(a)) {
        case "d":
          d += s("d", t.getDate(), 2);
          break;
    ...
    _possibleChars: function (i) {
      ...
      for (s = 0; s < i.length; s++) if (n) "'" !== i.charAt(s) || t("'") ? e += i.charAt(s) : n = !1;else switch (i.charAt(s)) {
        case "d":
        case "m":
        case "y":
        case "@":
    ...
    _generateHTML: function (t) {
      ...
      for (t.drawMonth = Z, t.drawYear = tt, i = this._get(t, "prevText"), i = q ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, Z - V, 1)), this._getFormatConfig(t)) : i, s = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w") + "'>" + i + "</span></a>" : Y ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w") + "'>" + i + "</span></a>", n = this._get(t, "nextText"), n = q ? this.formatDate(n, this._daylightSavingAdjust(new Date(tt, Z + V, 1)), this._getFormatConfig(t)) : n, o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e") + "'>" + n + "</span></a>" : Y ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e") + "'>" + n + "</span></a>", a = this._get(t, "currentText"), r = this._get(t, "gotoCurrent") && t.currentDay ? G : R, a = q ? this.formatDate(a, r, this._getFormatConfig(t)) : a, l = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", h = B ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (j ? l : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (j ? "" : l) + "</div>" : "", c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, d = this._get(t, "showWeek"), u = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), g = this._get(t, "monthNamesShort"), m = this._get(t, "beforeShowDay"), v = this._get(t, "showOtherMonths"), _ = this._get(t, "selectOtherMonths"), b = this._getDefaultDate(t), y = "", k = 0; k < U[0]; k++) {
        for (C = "", this.maxRows = 4, x = 0; x < U[1]; x++) {
          ...
          for (S += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + D + "'>" + (/all|left/.test(D) && 0 === k ? j ? o : s : "") + (/all|right/.test(D) && 0 === k ? j ? s : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, 0 < k || 0 < x, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>", I = d ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; w < 7; w++) I += "<th scope='col'" + (5 <= (w + c + 6) % 7 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + u[P = (w + c) % 7] + "'>" + p[P] + "</span></th>";

          for (S += I + "</tr></thead><tbody>", M = this._getDaysInMonth(tt, Z), tt === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, M)), H = (this._getFirstDayOfMonth(tt, Z) - c + 7) % 7, A = Math.ceil((H + M) / 7), z = X && this.maxRows > A ? this.maxRows : A, this.maxRows = z, O = this._daylightSavingAdjust(new Date(tt, Z, 1 - H)), E = 0; E < z; E++) {
            for (S += "<tr>", W = d ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(O) + "</td>" : "", w = 0; w < 7; w++) $ = m ? m.apply(t.input ? t.input[0] : null, [O]) : [!0, ""], F = (N = O.getMonth() !== Z) && !_ || !$[0] || Q && O < Q || J && J < O, W += "<td class='" + (5 <= (w + c + 6) % 7 ? " ui-datepicker-week-end" : "") + (N ? " ui-datepicker-other-month" : "") + (O.getTime() === T.getTime() && Z === t.selectedMonth && t._keyEvent || b.getTime() === O.getTime() && b.getTime() === T.getTime() ? " " + this._dayOverClass : "") + (F ? " " + this._unselectableClass + " ui-state-disabled" : "") + (N && !v ? "" : " " + $[1] + (O.getTime() === G.getTime() ? " " + this._currentClass : "") + (O.getTime() === R.getTime() ? " ui-datepicker-today" : "")) + "'" + (N && !v || !$[2] ? "" : " title='" + $[2].replace(/'/g, "&#39;") + "'") + (F ? "" : " data-handler='selectDay' data-event='click' data-month='" + O.getMonth() + "' data-year='" + O.getFullYear() + "'") + ">" + (N && !v ? "&#xa0;" : F ? "<span class='ui-state-default'>" + O.getDate() + "</span>" : "<a class='ui-state-default" + (O.getTime() === R.getTime() ? " ui-state-highlight" : "") + (O.getTime() === G.getTime() ? " ui-state-active" : "") + (N ? " ui-priority-secondary" : "") + "' href='#'>" + O.getDate() + "</a>") + "</td>", O.setDate(O.getDate() + 1), O = this._daylightSavingAdjust(O);

            S += W + "</tr>";
          }

          11 < ++Z && (Z = 0, tt++), C += S += "</tbody></table>" + (X ? "</div>" + (0 < U[0] && x === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "");
        }
  ...
  }, C.datepicker = new b(), C.datepicker.initialized = !1, C.datepicker.uuid = new Date().getTime(), C.datepicker.version = "1.12.1";
  C.datepicker;
  C.widget("ui.dialog", {
    version: "1.12.1",
    options: {
    ...
    _createButtons: function () {
      ...
      this.uiDialogButtonPane.remove(), this.uiButtonSet.empty(), C.isEmptyObject(t) || C.isArray(t) && !t.length ? this._removeClass(this.uiDialog, "ui-dialog-buttons") : (C.each(t, function (t, e) {
        var i, s;
        e = C.isFunction(e) ? {
          click: e,
          text: t
    ...
    _makeDraggable: function () {
      ...
      this.uiDialog.draggable({
        ...
        start: function (t, e) {
          n._addClass(C(this), "ui-dialog-dragging"), n._blockFrames(), n._trigger("dragStart", t, a(e));
        },
        drag: function (t, e) {
        ...
        stop: function (t, e) {
          ...
          o.position = {
            ...
            of: n.window
          }, n._removeClass(C(this), "ui-dialog-dragging"), n._unblockFrames(), n._trigger("dragStop", t, a(e));
        }
      });
    },
      ...
      this.uiDialog.resizable({
        ...
        stop: function (t, e) {
          ...
          a.height = o.uiDialog.height(), a.width = o.uiDialog.width(), a.position = {
            ...
            of: o.window
          }, o._removeClass(C(this), "ui-dialog-resizing"), o._unblockFrames(), o._trigger("resizeStop", t, r(e));
        }
      }).css("position", e);
    },
  ...
  C.ui.dialog, C.widget("ui.progressbar", {
    version: "1.12.1",
    options: {
      classes: {
    ...
    _createHandles: function () {
      ...
      this.handles = s.add(C(n.join("")).appendTo(this.element)), this._addClass(this.handles, "ui-slider-handle", "ui-state-default"), this.handle = this.handles.eq(0), this.handles.each(function (t) {
  ...
  C.widget("ui.spinner", {
    ...
    _events: {
      ...
      "mousedown .ui-spinner-button": function (t) {
        ...
        function i() {
          this.element[0] === C.ui.safeActiveElement(this.document[0]) || (this.element.trigger("focus"), this.previous = e, this._delay(function () {
            this.previous = e;
          }));
        }

        e = this.element[0] === C.ui.safeActiveElement(this.document[0]) ? this.previous : this.element.val(), t.preventDefault(), i.call(this), this.cancelBlur = !0, this._delay(function () {
          delete this.cancelBlur, i.call(this);
        }), !1 !== this._start(t) && this._repeat(null, C(t.currentTarget).hasClass("ui-spinner-up") ? 1 : -1, t);
      },
      "mouseup .ui-spinner-button": "_stop",
      "mouseenter .ui-spinner-button": function (t) {
        if (C(t.currentTarget).hasClass("ui-state-active")) return !1 !== this._start(t) && void this._repeat(null, C(t.currentTarget).hasClass("ui-spinner-up") ? 1 : -1, t);
      },
  ...
  C.widget("ui.tabs", {
    ...
    _isLocal: (P = /#.*$/, function (t) {
      var e, i;
      e = t.href.replace(P, ""), i = location.href.replace(P, "");
    ...
    _create: function () {
      ...
      }))).sort()), !1 !== this.options.active && this.anchors.length ? this.active = this._findActive(t.active) : this.active = C(), this._refresh(), this.active.length && this.load(t.active);
    },
    ...
    _findNextTab: function (t, e) {
      ...
      for (; -1 !== C.inArray((i < t && (t = 0), t < 0 && (t = i), t), this.options.disabled);) t = e ? t + 1 : t - 1;
  ...
  C.widget("ui.tooltip", {
    ...
    _open: function (t, e, i) {
      var s,
          ...
          o,
          a,
          r = C.extend({}, this.options.position);

      function l(t) {
        r.of = t, n.is(":hidden") || n.position(r);
      }

      i && ((s = this._find(e)) ? s.tooltip.find(".ui-tooltip-content").html(i) : (e.is("[title]") && (t && "mouseover" === t.type ? e.attr("title", "") : e.removeAttr("title")), s = this._tooltip(e), n = s.tooltip, this._addDescribedBy(e, n.attr("id")), n.find(".ui-tooltip-content").html(i), this.liveRegion.children().hide(), (a = C("<div>").html(n.find(".ui-tooltip-content").html())).removeAttr("name").find("[name]").removeAttr("name"), a.removeAttr("id").find("[id]").removeAttr("id"), a.appendTo(this.liveRegion), this.options.track && t && /^mouse/.test(t.type) ? (this._on(this.document, {
        mousemove: l
      }), l(t)) : n.position(C.extend({
        of: e
  ...
  function it(a) {
    var r = E(),
        l = r._rgba = [];
    return a = a.toLowerCase(), L(O, function (t, e) {
      var i,
          s = e.re.exec(a),
          n = s && e.parse(s),
          o = e.space || "rgba";
      if (n) return i = r[o](n), r[W[o].cache] = i[W[o].cache], l = r._rgba = i._rgba, !1;
    }), l.length ? ("0,0,0,0" === l.join() && M.extend(l, A.transparent), r) : A[a];
  }
  ...
  function nt(t) {
    var e,
        ...
        n = {};
    if (s && s.length && s[0] && s[s[0]]) for (i = s.length; i--;) "string" == typeof s[e = s[i]] && (n[C.camelCase(e)] = s[e]);else for (e in s) "string" == typeof s[e] && (n[e] = s[e]);
    return n;
  }
  ...
  C.effects = {
  ...
  }, N = E.support = {}, F = M("<p>")[0], L = M.each, F.style.cssText = "background-color:rgba(1,1,1,.5)", N.rgba = -1 < F.style.backgroundColor.indexOf("rgba"), L(W, function (t, e) {
    e.cache = "_" + t, e.props.alpha = {
      idx: 3,
      type: "percent",
      def: 1
    };
  }), E.fn = M.extend(E.prototype, {
    parse: function (n, t, e, i) {
      if (n === H) return this._rgba = [null, null, null, null], this;
      (n.jquery || n.nodeType) && (n = M(n).css(t), t = H);
      var o = this,
          s = M.type(n),
          a = this._rgba = [];
      return t !== H && (n = [n, t, e, i], s = "array"), "string" === s ? this.parse(it(n) || A._default) : "array" === s ? (L(W.rgba.props, function (t, e) {
        a[e.idx] = et(n[e.idx], e);
      }), this) : "object" === s ? (L(W, n instanceof E ? function (t, e) {
        ...
        }), o[s] && M.inArray(null, o[s].slice(0, 3)) < 0 && (o[s][3] = 1, i.from && (o._rgba = i.from(o[s])));
      }), this) : void 0;
    },
    is: function (t) {
      var n = E(t),
          o = !0,
          a = this;
      return L(W, function (t, e) {
        var i,
            s = n[e.cache];
        return s && (i = a[e.cache] || e.to && e.to(a._rgba) || [], L(e.props, function (t, e) {
    ...
    transition: function (t, a) {
      ...
      return r = r[i.cache], L(i.props, function (t, e) {
        var i = e.idx,
            s = l[i],
            n = r[i],
            o = $[e.type] || {};
        null !== n && (null === s ? h[i] = n : (o.mod && (n - s > o.mod / 2 ? s += o.mod : s - n > o.mod / 2 && (s -= o.mod)), h[i] = et((n - s) * a + s, e)));
      }), this[e](h);
    },
    blend: function (t) {
  ...
  }), E.fn.parse.prototype = E.fn, W.hsla.to = function (t) {
    ...
    var e = t[0] / 360,
        ...
        o = s <= .5 ? s * (1 + i) : s + i - s * i,
        a = 2 * s - o;
    return [Math.round(255 * st(a, o, e + 1 / 3)), Math.round(255 * st(a, o, e)), Math.round(255 * st(a, o, e - 1 / 3)), n];
  }, L(W, function (l, t) {
    var i = t.props,
        a = t.cache,
        r = t.to,
    ...
    E.fn[l] = function (t) {
      ...
      E.fn[a] || (E.fn[a] = function (t) {
        var e,
            ...
            n = this[s](),
            o = n[r.idx];
        return "undefined" === i ? o : ("function" === i && (t = t.call(this, o), i = M.type(t)), null == t && r.empty ? this : ("string" === i && (e = z.exec(t)) && (t = o + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)), n[r.idx] = t, this[s](n)));
      });
    });
  }), E.hook = function (t) {
    var e = t.split(" ");
    L(e, function (t, o) {
      M.cssHooks[o] = {
        set: function (t, e) {
          ...
          if ("transparent" !== e && ("string" !== M.type(e) || (i = it(e)))) {
            if (e = E(i || e), !N.rgba && 1 !== e._rgba[3]) {
        ...
        t.colorInit || (t.start = E(t.elem, o), t.end = E(t.end), t.colorInit = !0), M.cssHooks[o].set(t.elem, t.start.transition(t.end, t.pos));
      };
    });
  }, E.hook("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor"), M.cssHooks.borderColor = {
    expand: function (i) {
      var s = {};
    ...
    C.fx.step[e] = function (t) {
      ("none" !== t.end && !t.setAttr || 1 === t.pos && !t.setAttr) && (tt.style(t.elem, e, t.end), t.setAttr = !0);
    };
    ...
    return this.queue(function () {
      ...
      s = s.map(function () {
        ...
        return this.end = nt(this.el[0]), this.diff = function (t, e) {
          ...
          for (i in e) s = e[i], t[i] !== s && (q[i] || !C.fx.step[i] && isNaN(parseFloat(s)) || (n[i] = s));
  ...
  }), C.expr && C.expr.filters && C.expr.filters.animated && (C.expr.filters.animated = (U = C.expr.filters.animated, function (t) {
    return !!C(t).data(Z) || U(t);
  })), !1 !== C.uiBackCompat && C.extend(C.effects, {
    save: function (t, e) {
      for (var i = 0, s = e.length; i < s; i++) null !== e[i] && t.data(Q + e[i], t[0].style[e[i]]);
    },
    restore: function (t, e) {
      for (var i, s = 0, n = e.length; s < n; s++) null !== e[s] && (i = t.data(Q + e[s]), t.css(e[s], i));
    },
    ...
    effect: function () {
      function t(t) {
        var e = C(this),
            i = C.effects.mode(e, r) || o;
        e.data(Z, !0), l.push(i), o && ("show" === i || i === o && "hide" === i) && e.show(), o && "none" === i || C.effects.saveStyle(e), C.isFunction(t) && t();
      }
      ...
      function h(t) {
        ...
        function i() {
          C.isFunction(a) && a.call(e[0]), C.isFunction(t) && t();
        }

        s.mode = l.shift(), !1 === C.uiBackCompat || o ? "none" === s.mode ? (e[r](), i()) : n.call(e[0], s, function () {
          e.removeData(Z), C.effects.cleanUp(e), "hide" === s.mode && e.hide(), i();
        }) : (e.is(":hidden") ? "hide" === r : "show" === r) ? (e[r](), i()) : n.call(e[0], s, i);
      }

      return !1 === e ? this.each(t).each(h) : this.queue(i, t).queue(i, h);
    },
    show: (X = C.fn.show, function (t) {
      if (at(t)) return X.apply(this, arguments);
      var e = ot.apply(this, arguments);
      return e.mode = "show", this.effect.call(this, e);
    }),
    hide: (V = C.fn.hide, function (t) {
      if (at(t)) return V.apply(this, arguments);
      var e = ot.apply(this, arguments);
      return e.mode = "hide", this.effect.call(this, e);
    }),
    toggle: (K = C.fn.toggle, function (t) {
      if (at(t) || "boolean" == typeof t) return K.apply(this, arguments);
      var e = ot.apply(this, arguments);
    ...
    cssClip: function (t) {
      return t ? this.css("clip", "rect(" + t.top + "px " + t.right + "px " + t.bottom + "px " + t.left + "px)") : rt(this.css("clip"), this);
    },
    ...
    t.clipInit || (t.start = C(t.elem).cssClip(), "string" == typeof t.end && (t.end = rt(t.end, t.elem)), t.clipInit = !0), C(t.elem).cssClip({
      top: t.pos * (t.end.top - t.start.top) + t.start.top,
      right: t.pos * (t.end.right - t.start.right) + t.start.right,
      bottom: t.pos * (t.end.bottom - t.start.bottom) + t.start.bottom,
      left: t.pos * (t.end.left - t.start.left) + t.start.left
    });
  }, G = {}, C.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function (e, t) {
    G[t] = function (t) {
  ...
  C.effects, C.effects.define("blind", "hide", function (t, e) {
    var i = {
      up: ["bottom", "top"],
      vertical: ["bottom", "top"],
      down: ["top", "bottom"],
    ...
    for (C.effects.createPlaceholder(o), n = o.css(g), c = c || o["top" == g ? "outerHeight" : "outerWidth"]() / 3, l && ((s = {
      opacity: 1
    })[g] = n, o.css("opacity", 0).css(g, m ? 2 * -c : 2 * c).animate(s, p, f)), r && (c /= Math.pow(2, d - 1)), (s = {})[g] = n; v < d; v++) (i = {})[g] = (m ? "-=" : "+=") + c, o.animate(i, p, f).animate(s, p, f), c = r ? 2 * c : c / 2;

    r && ((i = {
      opacity: 0
    })[g] = (m ? "-=" : "+=") + c, o.animate(i, p, f)), o.queue(e), C.effects.unshift(o, _, 1 + u);
    ...
    }, C.effects.createPlaceholder(n), "show" === t.mode && (n.cssClip(s.clip), s.clip = i), n.animate(s, {
      queue: !1,
      duration: t.duration,
      easing: t.easing,
      complete: e
    ...
    for (i = 0; i < l; i++) for (o = u.top + i * f, r = i - (l - 1) / 2, s = 0; s < h; s++) n = u.left + s * p, a = s - (h - 1) / 2, c.clone().appendTo("body").wrap("<div></div>").css({
      position: "absolute",
      visibility: "visible",
      left: -s * p,
      top: -i * f
    ...
    }).animate(u, h, e.easing).animate(p, h, e.easing).queue(t), C.effects.unshift(i, g, 4);
    ...
    var t,
        ...
        p = s.css("position"),
        f = s.position(),
        g = C.effects.scaledDimensions(s),
        m = n.from || g,
        v = n.to || C.effects.scaledDimensions(s, 0);
    C.effects.createPlaceholder(s), "show" === h && (i = m, m = v, v = i), o = {
      from: {
        y: m.height / g.height,
        x: m.width / g.width
      },
    ...
    }, "box" !== d && "both" !== d || (o.from.y !== o.to.y && (m = C.effects.setTransition(s, r, o.from.y, m), v = C.effects.setTransition(s, r, o.to.y, v)), o.from.x !== o.to.x && (m = C.effects.setTransition(s, l, o.from.x, m), v = C.effects.setTransition(s, l, o.to.x, v))), "content" !== d && "both" !== d || o.from.y !== o.to.y && (m = C.effects.setTransition(s, a, o.from.y, m), v = C.effects.setTransition(s, a, o.to.y, v)), u && (t = C.effects.getBaseline(u, g), m.top = (g.outerHeight - m.outerHeight) * t.y + f.top, m.left = (g.outerWidth - m.outerWidth) * t.x + f.left, v.top = (g.outerHeight - v.outerHeight) * t.y + f.top, v.left = (g.outerWidth - v.outerWidth) * t.x + f.left), s.css(m), "content" !== d && "both" !== d || (r = r.concat(["marginTop", "marginBottom"]).concat(a), l = l.concat(["marginLeft", "marginRight"]), s.find("*[width]").each(function () {
      var t = C(this),
      ...
      complete: function () {
        var t = s.offset();
        0 === v.opacity && s.css("opacity", m.opacity), c || (s.css("position", "static" === p ? "relative" : p).offset(t), C.effects.saveStyle(s)), e();
      }
    });
